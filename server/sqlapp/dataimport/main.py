...
script_directory = os.path.dirname(os.path.abspath("C:\\Users\\Risha\\Documents\Vs_code\\teagarden\\server\\sqlapp\\models.py"))
sys.path.append(script_directory)
from models import *

script_directory1 = os.path.dirname(os.path.abspath("C:\\Users\\Risha\\Documents\Vs_code\\teagarden\\server\\sqlapp\\database.py"))
sys.path.append(script_directory1)
from database import *
excel_file_path = "C:\\Users\\Risha\\Documents\\Vs_code\\teagarden\\server\\sqlapp\\dataimport\\Arun Tea Estate (Sonitpur).xlsx"
